...
type Course = (typeof COURSE_OPTIONS)[number]["value"]
type Difficulty = (typeof DIFFICULTY_OPTIONS)[number]["value"]
type DietaryTag = (typeof DIETARY_TAGS)[number]["value"]
...
const emptyIngredient =
  (): FormValues["ingredientGroups"][number]["ingredients"][number] => ({
    name: "",
    quantity: 0,
    unit: "",
    prepNote: "",
...
const emptyIngredientGroup = (): FormValues["ingredientGroups"][number] => ({
  groupLabel: "",
  ingredients: [emptyIngredient()],
})

const emptyStep =
  (): FormValues["instructionGroups"][number]["steps"][number] => ({
    description: "",
    timerMinutes: undefined,
  })

const emptyInstructionGroup = (): FormValues["instructionGroups"][number] => ({
  groupLabel: "",
  steps: [emptyStep()],
})
